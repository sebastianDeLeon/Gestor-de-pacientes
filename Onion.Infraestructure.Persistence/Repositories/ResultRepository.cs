...
{
    public class ResultRepository : GenericRepository<ResultadoLaboratorio>, IResultadoLabRepository
    {
        private readonly AplicationContext _context;
        public ResultRepository(AplicationContext aplicationContext) : base(aplicationContext)
        {
